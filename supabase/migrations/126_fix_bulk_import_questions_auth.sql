-- ============================================================================
-- Migration 126: Fix Question Bank Bulk Import RBAC Authorization Check
--
-- Replaces public.bulk_import_questions_atomic RPC to use canonical
-- project authorization helper functions (public.is_super_admin() and
-- public.is_academic_admin()) instead of querying profiles.role directly.
--
-- Preserves all Text-Based question support, atomic chunking, options,
-- explanations, auto-publishing, audit logging, and security properties.
-- ============================================================================
