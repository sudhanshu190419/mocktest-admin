  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      createContent.mutate(
        {
          instituteId,
          teacherId: instituteId, // Will be resolved server-side
        ...
        {
          onSuccess: (content) => {
            router.push(`/teacher/content/${content.contentId}/edit`);
          },
          onError: (error) => {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* File Upload */}
        <section className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
          <h2 className="mb-4 text-base font-semibold text-gray-900">File Upload</h2>
          <div className="space-y-4">
            {/* Primary file */}
            <div>
            ...
            {/* Thumbnail */}
            <div>
              <label className="mb-1.5 block text-sm font-medium text-gray-700">Thumbnail (optional)</label>
              <div
                onDragOver={(e) => e.preventDefault()}
                onDrop={(e) => {
                  e.preventDefault();
