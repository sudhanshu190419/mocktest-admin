...
export const ScreenShareTile: React.FC<ScreenShareTileProps> = ({ trackRef }) => {
  return (
    <div className="relative w-full h-full bg-slate-950 rounded-3xl overflow-hidden border border-slate-800 shadow-2xl flex items-center justify-center">
      ...
      {/* Screen share badge */}
      <div className="absolute top-4 left-4 z-10 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-950/80 text-sky-400 text-xs font-bold backdrop-blur-md border border-white/10 shadow-lg">
