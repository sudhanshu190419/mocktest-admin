...
export const ResultReleaseBanner: React.FC<ResultReleaseBannerProps> = ({
  ...
  return (
    <div className="max-w-2xl mx-auto my-12 p-8 bg-white rounded-sheet border border-line shadow-xl text-center flex flex-col items-center gap-4">
      <div className="p-4 bg-amber-50 text-amber-600 rounded-card">
      ...
      {releasedAt && (
        <p className="text-xs font-semibold text-amber-800 bg-amber-50 px-4 py-2 rounded-field border border-amber-200">
      ...
      <div className="pt-4 w-full flex justify-center">
        <Link
          href="/student/tests"
          className="flex items-center gap-2 px-6 py-3 rounded-field font-bold text-sm bg-ink hover:bg-ink text-white transition-all shadow-md"
        >
