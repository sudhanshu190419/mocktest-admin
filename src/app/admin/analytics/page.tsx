      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {[
              { label: 'Student Analytics', href: '/admin/analytics/students', icon: '👥', color: 'bg-blue-600' },
              { label: 'Mock Test Analytics', href: '/admin/analytics/mock-tests', icon: '📝', color: 'bg-emerald-600' },
              { label: 'Subject Performance', href: '/admin/analytics/subjects', icon: '📚', color: 'bg-purple-600' },
              { label: 'Chapter Analysis', href: '/admin/analytics/chapters', icon: '📖', color: 'bg-amber-600' },
              { label: 'Trends', href: '/admin/analytics/trends', icon: '📈', color: 'bg-rose-600' },
              { label: 'Leaderboards', href: '/admin/analytics/leaderboards', icon: '🏆', color: 'bg-cyan-600' },
            ].map((action) => (
              <Link
                key={action.href}
                href={action.href}
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              {[
                { label: 'Draft Tests', value: testStats.draft, href: '/admin/mock-tests', color: 'text-gray-600', bg: 'bg-gray-50' },
                { label: 'Pending Approval', value: testStats.pending, href: '/admin/approvals', color: 'text-amber-600', bg: 'bg-amber-50' },
                { label: 'Unread Notifications', value: notifDash?.unreadCount ?? 0, href: '/admin/notifications', color: 'text-rose-600', bg: 'bg-rose-50' },
                { label: 'Results to Release', value: resultReleaseCount, href: '/admin/mock-tests', color: 'text-blue-600', bg: 'bg-blue-50' },
              ].map((item) => (
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
            <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-gray-100">Institute Stats</h3>
