...
export default function TeacherContentDashboardPage() {
  ...
  const quickActions = [
    {
      ...
      description: 'Create new learning material (PDF, video, notes, or assignment)',
    ...
    },
    {
      ...
      description: 'View, filter, and manage all your content items',
      href: '/teacher/content/list',
      icon: '📚',
  ...
  return (
    <div>
      <PageHeader title="My Content" description="Create and manage learning materials" />
