          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
            ...
            <div className="pl-2">
              ...
              <TimelineEvent
                ...
                description={notification.isRead ? 'You read this notification' : 'You have not read this yet'}
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
            ...
            <div className="space-y-2">
              ...
              <Link
                href={`/teacher/notifications/create?duplicate=${notification.notificationId}`}
                className="flex w-full items-center gap-2 rounded-lg bg-gray-50 px-4 py-2.5 text-left text-xs font-medium text-gray-700 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
              >
                📋 Duplicate
              </Link>
              <button
