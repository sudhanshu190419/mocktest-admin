...
export const TeacherVideoTile: React.FC<TeacherVideoTileProps> = ({
  ...
  if (isAudioOnly || !trackRef?.publication) {
    return (
      <div className="relative w-full h-full flex items-center justify-center bg-ink rounded-sheet overflow-hidden border border-ink">
  ...
  return (
    <div className="relative w-full h-full bg-ink rounded-sheet overflow-hidden border border-ink shadow-2xl flex items-center justify-center">
      <VideoTrack
        trackRef={trackRef}
      ...
      <div className="absolute bottom-4 left-4 z-10 inline-flex items-center gap-2 px-3 py-1.5 rounded-field bg-ink/80 text-white text-xs font-bold backdrop-blur-md border border-white/10 shadow-lg">
