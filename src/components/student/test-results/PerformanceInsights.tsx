...
export const PerformanceInsights: React.FC<PerformanceInsightsProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-900 to-slate-900 text-white rounded-3xl p-6 sm:p-8 border border-indigo-700/50 shadow-md flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
        {strongestSection && (
          <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700 flex items-start gap-2.5">
        ...
        {incorrectCount > 0 && (
          <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700 flex items-start gap-2.5">
            <Target size={18} weight="bold" className="text-sky-400 shrink-0 mt-0.5" />
            <div>
              <span className="text-xs font-bold text-sky-300">Negative Marks Reduction</span>
              <p className="text-xs text-slate-300 mt-0.5">
