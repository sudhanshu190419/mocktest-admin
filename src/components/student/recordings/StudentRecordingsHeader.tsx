...
export const StudentRecordingsHeader: React.FC<StudentRecordingsHeaderProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r bg-brand bg-brand-hover bg-brand-hover rounded-sheet p-6 sm:p-8 text-white shadow-md relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 backdrop-blur-xs text-brand text-xs font-bold border border-white/20">
            <IconFilm size={14} className="text-sky-ink" />
        ...
        <div className="relative z-10 flex items-center gap-3 self-start md:self-auto flex-wrap">
          <div className="flex items-center gap-2.5 px-4 py-3 rounded-card bg-white/10 backdrop-blur-md border border-white/15">
            <IconClock size={20} className="text-sky-ink" />
            <div>
          ...
          <div className="flex items-center gap-2.5 px-4 py-3 rounded-card bg-white/10 backdrop-blur-md border border-white/15">
            <IconCheckCircle size={20} className="text-emerald-300" />
            <div>
          ...
          <button
            ...
            className="p-3 rounded-card bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/15 text-white transition-all active:scale-[0.98] disabled:opacity-50"
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-line">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-field text-xs font-bold transition-all ${
                selectedSubject === 'all'
          ...
          <div className="flex items-center gap-2.5 ml-auto flex-wrap">
            {availableBatches.length > 1 && (
              <select
                ...
                className="px-3 py-1.5 rounded-field bg-paper border border-line text-xs font-semibold text-ink focus:outline-hidden focus:border-brand transition-colors"
              >
