...
export default function PyqPackageListPage() {
    ...
    },
    {
      ...
      render: (p) => (
        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
          <>
            <Link
              href={`/teacher/pyq/packages/${p.packageId}/edit`}
  ...
  return (
    <div>
      <PageHeader
        title="PYQ Packages"
        description={`${totalCount} package${totalCount !== 1 ? 's' : ''} created`}
        breadcrumbs={[
        ...
        actions={
          <Link
            href="/teacher/pyq/packages/create"
      ...
      <DataTable<PyqPackage>
        ...
        onRowClick={(p) => router.push(`/teacher/pyq/packages/${p.packageId}/edit`)}
        isLoading={isLoading}
        sortable
        page={page}
        pageSize={PAGE_SIZE}
