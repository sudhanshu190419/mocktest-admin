...
import { XCircle, SignOut, ShieldCheck } from '@phosphor-icons/react';
...
export default function AccountRejectedPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-red-950 to-slate-900 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md mx-auto">
        {/* Card */}
        <div className="rounded-3xl bg-white shadow-2xl border border-slate-100 overflow-hidden">
          {/* Illustration area */}
          <div className="h-48 bg-gradient-to-br from-red-50 via-red-100/50 to-rose-50 flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full bg-red-400 blur-[80px]" />
            </div>
            <div className="relative flex flex-col items-center gap-2">
              <div className="w-20 h-20 rounded-full bg-red-100 border-4 border-red-200 flex items-center justify-center">
                <XCircle size={36} weight="duotone" className="text-red-500" />
              </div>
            </div>
          </div>
          ...
          <div className="p-8 pt-6 text-center space-y-4">
            {/* Badge */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-50 border border-red-200/60">
