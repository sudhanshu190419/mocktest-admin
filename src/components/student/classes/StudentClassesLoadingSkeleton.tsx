    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="h-10 w-28 bg-sky-tint rounded-xl" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-24 bg-white rounded-3xl border border-line p-4 space-y-2">
      ...
      {/* Hero card skeleton */}
      <div className="h-48 bg-ink/60 rounded-3xl border border-ink p-6 space-y-4" />

      {/* Tabs and filter bar skeleton */}
      <div className="flex flex-col md:flex-row items-center justify-between gap-3">
        <div className="h-11 w-64 bg-sky-tint rounded-2xl" />
        <div className="flex items-center gap-2 w-full md:w-auto">
          <div className="h-11 w-full md:w-56 bg-sky-tint rounded-2xl" />
          <div className="h-11 w-32 bg-sky-tint rounded-2xl" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="h-64 bg-white rounded-3xl border border-line p-5 space-y-3">
            ...
            <div className="h-9 w-full bg-sky-tint rounded-xl" />
          </div>
        ))}
      </div>
    </div>
